...
typedef NS_ENUM(NSUInteger, MAGSliderLayoutDirection) {
   MAGSliderLayoutDirectionHorizontal  = 0,
   MAGSliderLayoutDirectionVertical,
};


@interface MAGSliderSetting : NSObject
//（默认）配置
...
//布局方式（垂直或水平）
@property (assign, nonatomic) MAGSliderLayoutDirection layoutDirection;
//背景色
