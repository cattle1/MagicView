...
@interface MAGViewController : MAGNavigationBarViewController<UITableViewDataSource, UITableViewDelegate, UICollectionViewDataSource, UICollectionViewDelegate>
...
/// @note 当控制器消失时会自动删除保存的请求，success 和 failure 内可以正常使用 self 不会造成循环
